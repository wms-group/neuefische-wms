...
public class HallManagementService {
	...
	public HallManagementService(HallRepository hallRepo, AisleService aisleService, IdService idService) {
	...
	public void deleteHall(String id) throws HallNotFoundException, AisleNotFoundException {
